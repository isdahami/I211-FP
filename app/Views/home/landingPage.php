...
<?= $this->section("content") ?>
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img class="d-block w-100" src="<?= base_url('assets/images/hero-images/offspring.jpg')?>" alt="First slide">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="<?= base_url('assets/images/hero-images/RS.jpg')?>" alt="First slide">
        </div>
    </div>
